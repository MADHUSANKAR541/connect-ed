...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'verification' | 'colleges' | 'insights' | 'moderation' | 'announcements'>('overview');
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'user_approved': return <CheckCircle size={16} />;
      case 'user_rejected': return <XCircle size={16} />;
      case 'college_added': return <Building2 size={16} />;
  ...
  const handleApproveUser = async (userId: number) => {
    try {
      setPendingUsers((prev: any[]) => prev.map(u => u.id === userId ? { ...u, _loading: 'approve' } : u));
      ...
      setPendingUsers((prev: any[]) => prev.map(u => u.id === userId ? { ...u, _loading: undefined } : u));
    }
  };

  const handleRejectUser = async (userId: number) => {
    try {
      setPendingUsers((prev: any[]) => prev.map(u => u.id === userId ? { ...u, _loading: 'reject' } : u));
          ...
          {navItems.map((item) => {
            ...
            return (
              <a
                key={item.href}
                href={item.href}
                className={`nav-item icon-nav-item ${item.href === '/admin' ? 'active' : ''}`}
                title={item.label}
              >
                <Icon size={24} />
              </a>
          ...
          <div className="admin-page">
            <div className="admin-header">
              <div className="header-content">
                ...
                <p className="page-subtitle">Manage user verification, college access, and platform settings</p>
              </div>
                        ...
                        <div key={activity.id} className="activity-item">
                          ...
                          <div className="activity-content">
                            ...
                            <p className="activity-description">
                              ...
                              {activity.type === 'user_approved' && `${activity.user} was approved`}
                              {activity.type === 'user_rejected' && `${activity.user} was rejected`}
                              {activity.type === 'college_added' && `${activity.college} was added`}
                            </p>
                            <span 
                ...
                >
                  <div className="content-header">
                    ...
                    <div className="verification-stats">
                      <span className="stat-badge pending">{pendingUsers.length} Pending</span>
                    </div>
                  </div>
                        ...
                        <tbody>
                          {pendingUsers.map((user) => (
                            <tr key={user.id}>
                              ...
                              <td>{user.colleges?.name || user.college || '-'}</td>
                              <td>
                                <span className="role-badge">{user.role}</span>
                              </td>
                              <td>{user.department || '-'}</td>
                              <td>
                                <span className="verification-badge">{user.verificationMethod || '-'}</span>
                              </td>
                              ...
                              <td>
                                <div className="action-buttons">
                                  ...
                                  >
                                    {user._loading === 'approve' ? '...' : <CheckCircle size={16} />}
                                  </button>
                                  <button 
                                  ...
                                  >
                                    {user._loading === 'reject' ? '...' : <XCircle size={16} />}
                                  </button>
                        ...
                        <div className="college-stats">
                          ...
                          <div className="stat">
                            ...
                            <span className="stat-value">
                              {college.crossCollegeConnections ? 'Enabled' : 'Disabled'}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="setting-list">
                        <div className="setting-item">
                          <div className="setting-info">
                            ...
                            <span className="setting-description">Allow users to upload resumes</span>
                          </div>
                        ...
                        <div className="setting-item">
                          <div className="setting-info">
                            <span className="setting-label">Call Scheduling</span>
                            <span className="setting-description">Enable video call scheduling</span>
                          </div>
                          <label className="toggle-switch">
                            <input type="checkbox" defaultChecked />
                            <span className="toggle-slider"></span>
                        ...
                        <div className="setting-item">
                          <div className="setting-info">
                            ...
                            <span className="setting-description">Allow direct messaging</span>
                          </div>
                          <label className="toggle-switch">
                            <input type="checkbox" defaultChecked />
                            <span className="toggle-slider"></span>
                  ...
                  <div className="announcements-grid">
                    <div className="announcement-card">
                      <div className="announcement-header">
                        ...
                        <span className="announcement-status active">Active</span>
                      </div>
                      <p className="announcement-content">
                        Join us for the annual alumni meetup on March 15th, 2024. Network with fellow alumni and share your experiences.
                      </p>
                    ...
                    <div className="announcement-card">
                      <div className="announcement-header">
                        ...
                        <span className="announcement-status scheduled">Scheduled</span>
                      </div>
                      <p className="announcement-content">
                        Register now for the upcoming job fair featuring top companies from various industries.
                      </p>
                      <div className="announcement-meta">
